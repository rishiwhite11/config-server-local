...
@SpringBootTest(classes=ConfigServerLocalApplication.class)
@WebAppConfiguration
...
public class ConfigServerLocalApplicationTests {
	...
	public void propertyLoadTest() throws Exception {
		...
		MvcResult result =
			mockMvc.perform(get("/fimt-dev.properties"))
		...
		assertTrue(returned.contains("value:"));
		assertTrue(returned.contains("fimt-dev"));
	}
